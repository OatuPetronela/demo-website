...
<?php require_once('includes/header.php');?>
        <h1 class="titileMovies">Avatar</h1>
        <div class="row mt-5 ml-4 mr-1" >
            <div class="col-sm-4 col-md-4 col-xl-4">
                <img src="https://resizing.flixster.com/kACYoBcDXPDb-kl4iTX4kQPUcaM=/206x305/v2/https://flxt.tmsimg.com/assets/p3542039_p_v8_am.jpg" alt="Avatar" style="width: 100%;">
            </div>
            <div class="col-sm-8 col-md-8 col-xl-8">
                <h2>December 10, 2009</h2>
                <p >Avatar is a 2009 American epic science fiction film directed, written, produced, and co-edited by James Cameron and starring Sam Worthington, Zoe Saldana, Stephen Lang, Michelle Rodriguez, and Sigourney Weaver. The film is set in the mid-22nd
                    ...
                    office records and became the highest-grossing film at the time, as well as in the United States and Canada, surpassing Cameron's Titanic, which had held those records for twelve years. <br><br><strong> Directed by:	James Cameron<br>Running time: 162 minutes<br>Cast:</strong></p>
                <ul>
